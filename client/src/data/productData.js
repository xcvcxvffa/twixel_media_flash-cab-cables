export const productCategories = [
  ...
  },
  {
    ...
    subCategories: [],
    specs: {
      cableStandard: 'IS 694 / IEC 60227',
      salientFeatures: [
        'Highly Flexible Class 5 Bare Copper Conductor',
        'Flame Retardant PVC Insulation & Sheath',
        'Excellent Bending Radius & Flexibility',
        'Resistance to Moisture, Abrasion & Oils'
      ],
      technicalData: {
        'Voltage Grade ': 'High Purity Annealed Copper',
        'Insulation': 'PVC / HRPVC / XLPE',
        'Flexibility': 'High Flexibility for Easy Installation',
        'Flame Retardant': 'FR Grade Available',
        'Temperature Rating': 'Up to 70°C (PVC) / 90°C (XLPE)',
        'Voltage Grade': 'Up to 1100 V',
        'Dielectric Strength': 'High Dielectric Strength for Safety',
        'Moisture Resistance': 'Excellent Resistance to Moisture & Oils',
        'Durability': 'Long Service Life & Reliable Performance'
      },
      standardPacking: {
        'Conductor': 'Class 5 Flexible Bare Copper',
        'Insulation': 'PVC (Flame Retardant)',
        'Outer Sheath': 'PVC (FR / FRLS)',
        'Core Identification': 'Color coded / Numbered'
      },
      coreColour: 'Single Core: Red, Black, Blue, Yellow, Green/Yellow. Multi Core: Color coded up to 5 cores, numbered for more cores.',
      application: 'Single Core & Multi Core Flexible Cables are designed for reliable power transmission with excellent flexibility and durability. Ideal for residential, commercial, and industrial applications, they ensure safe, efficient, and hassle-free installation in various electrical systems.',
      tableData: []
    }
  },
  {
  ...
  },
  {
    ...
    specs: {
      ...
      coreColour: 'As Par IS:694:2010 - 3C - Red, Yellow, Blue. As Par IEC:60227 3C Black, Blue, Brown.',
      ...
      tableData: [
        { size: '1.0', wires: '14/0.30', insThick: '0.60', coreOD: '2.60', sheathThick: '0.90', over3Core: '9.90 X 4.70', over4Core: 'N/A', res: '18.1', rating: '11' },
        { size: '1.5', wires: '22/0.30', insThick: '0.60', coreOD: '2.80', sheathThick: '0.90', over3Core: '10.50 X 4.80', over4Core: 'N/A', res: '12.1', rating: '14' },
        { size: '2.5', wires: '36/0.30', insThick: '0.70', coreOD: '3.35', sheathThick: '1.0', over3Core: '12.60 X 5.90', over4Core: 'N/A', res: '7.41', rating: '18' },
        { size: '4.0', wires: '56/0.30', insThick: '0.80', coreOD: '4.0', sheathThick: '1.0', over3Core: '14.50 X 6.70', over4Core: 'N/A', res: '4.95', rating: '26' },
        { size: '6.0', wires: '84/0.30', insThick: '0.80', coreOD: '5.0', sheathThick: '1.0', over3Core: '17.50 X 7.50', over4Core: 'N/A', res: '3.30', rating: '31' },
        { size: '10.0', wires: '140/0.30', insThick: '1.0', coreOD: '6.5', sheathThick: '1.40', over3Core: '22.80 X 9.90', over4Core: 'N/A', res: '1.91', rating: '42' }
      ]
    }
  },
  {
  ...
  },
  {
    ...
    specs: {
      ...
      salientFeatures: [
        'Flame Retardant (FR) / Flame Retardant Low Smoke (FRLS) PVC',
        'Class 5 High Conductivity Copper Conductor',
        'Anti-rodent and Anti-termite properties',
        'High insulation resistance prevents leakage'
      ],
      technicalData: {
        'Conductor Material': 'Annealed Copper',
        'Conductor Type': 'Flexible (Class 5)',
      ...
      standardPacking: {
        'Conductor': 'Class 5 Flexible Bare Copper',
        'Insulation': 'FR / FRLSH PVC Compound',
        'Coil Length': '90 m, 180 m, or project reels'
      },
      coreColour: 'Red, Yellow, Blue, Black, Green.',
      application: 'House wires are electrical cables designed for internal wiring in residential buildings. Built with high-quality insulation to ensure safety, these wires are used for distributing electricity to outlets, lights, and appliances within a home. They are flame-resistant, durable, and come in various colors for easy identification during installation, making them an essential component in safe and efficient home electrical systems.',
      tableData: []
    }
  },
  {
  ...
  },
  {
    ...
    specs: {
      ...
      currentRatingText: 'The maximum current ratings of flexible welding cables for different duty cycles are based on an ambient air temperature of 25°C and a maximum conductor temperature of 90°C. The percentage duty cycles for various processes and applications are as follows:',
      dutyCycles: [
        { label: 'Automobile Welding', value: 'up to 100%' },
        { label: 'Semi Automatic Welding', value: '30% to 85%' },
        { label: 'Manual Welding', value: '0% to 60%' },
        { label: 'Very intermittent or Occasional Welding', value: 'up to 20%' }
      ],
      voltageDropText: 'When total cable lengths in excess of 15mtr., are involved, it may be necessary to use cables of larger cross section to ensure that the voltage drop is not excessive & welding currents are maintained at adequate levels.',
      tableData: [
        { size: '10.0', innerIns: '1.0', sheath: '1.10', diaSingle: '7.0', diaDouble: '8.50', res: '1.910', cur100: '105', cur85: '115', cur60: '135', cur30: '190', cur20: '235', nonWelding: '110' },
        { size: '16.0', innerIns: '1.10', sheath: '1.30', diaSingle: '9.0', diaDouble: '10.0', res: '1.210', cur100: '135', cur85: '145', cur60: '175', cur30: '245', cur20: '302', nonWelding: '138' },
        { size: '25.0', innerIns: '1.20', sheath: '1.40', diaSingle: '10.30', diaDouble: '12.0', res: '0.780', cur100: '180', cur85: '195', cur60: '230', cur30: '330', cur20: '402', nonWelding: '187' },
        { size: '35.0', innerIns: '1.20', sheath: '1.60', diaSingle: '11.85', diaDouble: '13.50', res: '0.554', cur100: '225', cur85: '245', cur60: '290', cur30: '410', cur20: '503', nonWelding: '233' },
        { size: '50.0', innerIns: '1.30', sheath: '1.70', diaSingle: '14.0', diaDouble: '15.20', res: '0.386', cur100: '285', cur85: '310', cur60: '370', cur30: '520', cur20: '637', nonWelding: '295' },
        { size: '70.0', innerIns: '1.40', sheath: '1.80', diaSingle: '15.80', diaDouble: '18.0', res: '0.272', cur100: '355', cur85: '385', cur60: '460', cur30: '650', cur20: '794', nonWelding: '372' },
        { size: '95.0', innerIns: '1.80', sheath: '2.0', diaSingle: '17.70', diaDouble: '20.60', res: '0.206', cur100: '430', cur85: '470', cur60: '560', cur30: '790', cur20: '961', nonWelding: '449' },
        { size: '120.0', innerIns: '2.0', sheath: '2.10', diaSingle: '19.50', diaDouble: '23.0', res: '0.161', cur100: '500', cur85: '540', cur60: '650', cur30: '910', cur20: '1118', nonWelding: '523' }
      ],
      tempFactors: [
        { temp: '20°', factor: '1.04' },
        { temp: '25°', factor: '1.04' },
