    ...
    const onSetFormFile = async (
        ...
        if (file[0]) {
            ...
            try {
                ...
                if (result.url) {
                    form.setFieldValue(field.name, result.url)
                }
            } catch (error) {
    ...
    const onFormSubmit = async (
        ...
        try {
            ...
            if (resp.data) {
                ...
                // Update global state so header and dropdown reflect the change
                dispatch(setUser({
                    ...currentUser,
            ...
            toast.push(<Notification title={'Error updating profile'} type="danger" />, {
                placement: 'top-center',
            })
        } finally {
            setSubmitting(false)
